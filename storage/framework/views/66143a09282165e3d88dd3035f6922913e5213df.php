    ...
    <tbody>
        ...
        <tr>
            ...
            <td>  
                 ...
                 <?php if($admin_email=='admin@ninja11.in'): ?>
                <a href="<?php echo e(env('api_base_url')); ?>/railLogic?match_id=<?php echo e($result->match_id); ?>&contest_id=<?php echo e($result->contest_id); ?>&team_id=<?php echo e($result->created_team_id); ?>"  data-toggle="modal" data-target="#railLogic_<?php echo e($result->id); ?>">
                ...
                <?php if($admin_email=='admin@ninja11.in'): ?>
                 <a href="<?php echo e(env('api_base_url')); ?>/railLogic?match_id=<?php echo e($result->match_id); ?>&contest_id=<?php echo e($result->contest_id); ?>&team_id=<?php echo e($result->created_team_id); ?>&with_edit=1"  data-toggle="modal" data-target="#railLogic_<?php echo e($result->id); ?>">
                    <button class="btn btn-success btn-xs" >
                       Rail Logic E
                    <i class="fa fa-fw fa-eye" title="edit"></i> 
                    </button>
                ...
                <a href="#"  data-toggle="modal" data-target="#lastSeen_<?php echo e($result->id); ?>" >
                    <button class="btn btn-success btn-xs" >
                       Last Seen
                    <i class="fa fa-fw fa-eye" title="edit"></i> 
                    </button>
                </a> <br><br>
                <!--  <a href="<?php echo e(env('api_base_url')); ?>/joinContestfromRB?match_id=<?php echo e($result->match_id); ?>&contest_id=<?php echo e($result->contest_id); ?>&limit=1" target="_blank">
...
<div class="modal fade" id="lastSeen_<?php echo e($result->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg  " role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
         ...
         <table class="table table-striped table-hover table-bordered" id="contact">
          ...
          <tbody>
            <?php $__currentLoopData = $lastSeen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($key+1); ?> </td>
              <td><?php echo e($team->team_name); ?></td>
              <td><?php echo e($team->seentime); ?></td>
              <td><?php echo e($team->seenby); ?></td>
              <td><?php echo e($team->event_name); ?></td>  
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="railLogic_<?php echo e($result->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg  " role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<span>
 ...
 <div class="center" align="center">  <?php echo $matchTeams->appends(['search' => isset($_GET['search'])?$_GET['search']:'','contest_id' => isset($_GET['contest_id'])?$_GET['contest_id']:''])->render(); ?></div>
</div>
                    </div>
...
<?php echo $__env->make('packages::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web/modules/Admin/views/matchContest/matchTeams.blade.php ENDPATH**/ ?>