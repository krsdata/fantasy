...
<html lang="en">
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('assets/img/fav.png')); ?>" />
        ...
        <link href="<?php echo e(URL::asset('assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css')); ?>" rel="stylesheet" type="text/css" />
         <link href="<?php echo e(URL::asset('assets/global/plugins/ladda/ladda-themeless.min.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(URL::asset('assets/global/css/bootstrap-multiselect.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="<?php echo e(URL::asset('assets/layouts/layout4/css/layout.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(URL::asset('assets/layouts/layout4/css/themes/default.min.css')); ?>" rel="stylesheet" type="text/css" id="style_color" />
        <link href="<?php echo e(URL::asset('assets/layouts/layout4/css/custom.min.css')); ?>" rel="stylesheet" type="text/css" />
        <!-- END THEME LAYOUT STYLES -->
        <link href="<?php echo e(URL::asset('assets/global/plugins/select2/css/select2.min.css')); ?>" rel="stylesheet" type="text/css" />

        <link href="<?php echo e(URL::asset('assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css')); ?>" rel="stylesheet" type="text/css" />

        <link href="<?php echo e(URL::asset('assets/global/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo e(URL::asset('assets/apps/css/todo-2.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(URL::asset('assets/pages/css/profile.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(URL::asset('assets/css/bootstrap-datetimepicker.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php /**PATH /var/www/web/modules/Admin/views/layouts/header.blade.php ENDPATH**/ ?>