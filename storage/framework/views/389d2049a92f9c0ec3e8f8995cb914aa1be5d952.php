...
<section class="content-wrap " style="background-image: url(<?php echo e(url('webmedia/images/c0.jpg')); ?>); height: 500px" data-section="home" id="home-section">
...
<?php endif; ?>
        ...
        <div class="address col-md-12">
          ...
          <h4>Visit Us</h4>
          <p><?php echo e(env('company_email')); ?></p>
        </div>
        <div class="address second col-md-12">
          <i class="icon icon-envelope border_radius"></i>
          <h4>Email Us</h4>
          <p><a href="mailto:<?php echo e(env('company_name')); ?>"><?php echo e(env('company_email')); ?></a></p>
        </div>
        <div class="address col-md-12">
          <i class="icon icon-phone border_radius"></i>
          <h4>Call Us</h4>
          <p>   Mo. No -  <?php echo e(env('company_phone')); ?></p>
<p></p>
        </div>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web/resources/views/contactus.blade.php ENDPATH**/ ?>