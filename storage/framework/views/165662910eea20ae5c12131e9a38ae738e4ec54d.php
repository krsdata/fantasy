    ...
    <section class="content-wrap" style="background-image: url('<?php echo e(url('webmedia/images/cricg.jpg')); ?>');" data-section="home" data-stellar-background-ratio="0.5" id="home-section">
    ...
    <!--Section: Content-->
        ...
        <section class="ftco-section ftco-services-2" id="services-section">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p><?php echo e(env('company_name')); ?> fantasy league</p>
          </div>
        </div>
        <div class="row">
            ...
            <div class="media block-6 services text-center d-block rainbow">
              ...
              <div class="media-body">
                ...
                <p><?php echo e(env('company_name')); ?> Fantasy League allows you to participate in the fantasy sports where you
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                ...
                <p>Download the <?php echo e(env('company_name')); ?> app to access exciting features easily. Also, the app is super
          ...
          <div class="col-md d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-lg-4">
              ...
              <div class="media-body">
                ...
                <p><?php echo e(env('company_name')); ?> Fantasy League is a dream come true for the users, as they get an excellent
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate mt-lg-5">
            <div class="media block-6 services text-center d-block mt-lg-5 pt-md-5 pt-lg-4">
              ...
              <div class="media-body p-md-3">
                ...
                <p class="mb-5"  style="color: #000"><?php echo e(env('company_name')); ?> gives you an opportunity to organize the best team, choosing from real-life
...
are getting rewarded based on their ranks.</p>
    ...
    <div class="jumbotron jumbotron-fluid" style="margin: 0px">
          <div class="container center">
            <h1>Reach us at <?php echo e(env('company_email')); ?> </h1>
            
          </div>
      </div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web/resources/views/aboutus.blade.php ENDPATH**/ ?>