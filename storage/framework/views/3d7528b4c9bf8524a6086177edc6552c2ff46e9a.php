  ...
  -->
										 	<div class="form-group <?php echo e($errors->first('title', ' has-error')); ?>  <?php if(session('field_errors')): ?> <?php echo e('has-error'); ?> <?php endif; ?>">
										        <label class="control-label col-md-3">  Offer Title <span class="required"> * </span></label>
										        <div class="col-md-4"> 
										            <?php echo Form::text('title',null, ['class' => 'form-control','data-required'=>1,'required'=>'required']); ?> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                  <?php echo Form::submit(' Save ', ['class'=>'btn  btn-primary text-white','id'=>'saveBtn']); ?>
                                                   ...
                                                   <a href="<?php echo e(route('bannerOffer')); ?>">
...
<?php /**PATH /var/www/web/modules/Admin/views/bannerOffer/form.blade.php ENDPATH**/ ?>