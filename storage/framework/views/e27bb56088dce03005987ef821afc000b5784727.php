                                              ...
                                              <td>
                                               <div class="mt-checkbox-list">
                                                ...
                                                <td> <?php echo e($result->match_id); ?> </td>
                                                 ...
                                                 <td> <a class="btn btn-success" href="https://rest.fancode11.com/api/v3/saveMatchDataByMatchId/<?php echo e($result->match_id); ?>"  data-target="#saveMatch" data-toggle="modal" >
                                                  Save This Match
                                                 </a> 
                                                </td>
                                                <td> <a class="btn btn-success" href="https://rest.fancode11.com/api/v3/saveMatchDataByMatchId/<?php echo e($result->match_id); ?>?Playing11=true"  data-target="#saveMatch" data-toggle="modal" >
                                                  Enable Playing 11
                                                 </a> 
                                                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('packages::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web/modules/Admin/views/flashMatch/tempMatch.blade.php ENDPATH**/ ?>