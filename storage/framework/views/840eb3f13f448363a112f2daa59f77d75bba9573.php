...
<div class="form-body col-md-6">
    ...
    <div class="form-group <?php echo e($errors->first('campaign_name', ' has-error')); ?>">
        ...
        <div class="form-group <?php echo e($errors->first('amount', ' has-error')); ?>">
            ...
            <div class="col-md-7"> 
                <?php echo Form::text('deposit',0, ['class' => 'form-control','onkeypress'=>'return isNumberKey(event)']); ?> 
...
<div class="form-body col-md-6">
    ...
    <div class="form-group <?php echo e($errors->first('promotion_type', ' has-error')); ?>  <?php if(session('field_errors')): ?> <?php echo e('has-group'); ?> <?php endif; ?>">
            ...
            <div class="col-md-7"> 
                ...
                <?php echo e(Form::select('promotion_type' , ['0'=>'Select Type','1'=>'Referral',2=>'Bonus','Deposit'], $program->promotion_type,['class' => 'form-control'])); ?>
     ...
     <div class="form-group <?php echo e($errors->first('trigger_condition', ' has-error')); ?>  <?php if(session('field_errors')): ?> <?php echo e('has-group'); ?> <?php endif; ?>">
            ...
            <div class="col-md-7"> 
                ...
                <?php echo e(Form::select('trigger_condition', [0=>'Select Condition','1'=>'Sign Up',2=>'First Transaction','3'=>'Deposit'], $program->trigger_condition,['class' => 'form-control'])); ?>
...
<?php /**PATH /var/www/web/modules/Admin/views/program/form.blade.php ENDPATH**/ ?>