                                    ...
                                    <div class="table-toolbar">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                     ...
                                                     <?php echo e(Form::select('contest_type',$contest_type, $_GET['contest_type']??0, ['class' => 'form-control','onchange'=>"this.form.submit()"])); ?>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="contact">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo e($contest_type[$result->contest_type]); ?>

                                                    <?php echo $result->match_id?'<span class="required" aria-required="true"> * </span>':''; ?>

                                                 </td>
                                                  <th>  <?php echo e($result->cancellation?'Yes':'No'); ?> </th>

                                                <th>  
                                                    <?php echo e($result->is_free?'Yes':'No'); ?>
...
Edit
                                    ...
                                    <span>
                                     ...
                                     <div class="center" align="center">  <?php echo $defaultContest->appends(['search' => isset($_GET['search'])?$_GET['search']:'','contest_type'=>$_GET['contest_type']??null])->render(); ?></div>
                                </div>
                            </div>
      ...
      <?php /**PATH /var/www/web/modules/Admin/views/defaultContest/home.blade.php ENDPATH**/ ?>