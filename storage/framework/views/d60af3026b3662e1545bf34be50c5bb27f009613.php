    ...
    <section class="content-wrap" style="" data-section="home" data-stellar-background-ratio="0.5" id="home-section">
      <img src="<?php echo e(URL::asset('webmedia/images/cricg.jpg')); ?>" width="100%"> 
    </section>
    <?php endif; ?>
<style type="text/css">
  .page_title{
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/web/resources/views/page.blade.php ENDPATH**/ ?>