            ...
            <?php $__currentLoopData = $wallets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <a href="<?php echo e(route('paymentsHistory','search='.$result->user_id.'&payment_type='.$result->payment_type)); ?>">
                            <button class="btn btn-success btn-sm">
                                Payments History
                        ...
                        <a href="<?php echo e(route('wallets.edit',$result->id)); ?>?payment_type=<?php echo e($result->payment_type); ?>">
                            <button class="btn btn-success btn-sm">
...
<span>
  ...
  of  <?php echo e($wallets->total()); ?> entries 
        ...
        <?php /**PATH /var/www/web/modules/Admin/views/wallets/home.blade.php ENDPATH**/ ?>