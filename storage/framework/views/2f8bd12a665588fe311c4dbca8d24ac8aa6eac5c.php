...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="copyright"> <?php echo e(date('Y')); ?> © sportfight. All rights reserved </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
...
</html><?php /**PATH /var/www/web/modules/Admin/views/auth/passwords/email.blade.php ENDPATH**/ ?>