...
<html lang="en">
    ...
    <?php echo Form::model($user, ['url' => ['admin/login'],'class'=>'form-horizontal login-form','files' => true]); ?>
       ...
       <?php echo $__env->make('packages::auth.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo Form::close(); ?>
        ...
        <div class="copyright"> <?php echo e(date('Y')); ?> © <?php echo e(env('company_name')); ?>. All rights reserved </div>
        <!-- END LOGIN -->
        <!--[if lt IE 9]>
...
<?php /**PATH /var/www/web/modules/Admin/views/auth/login.blade.php ENDPATH**/ ?>