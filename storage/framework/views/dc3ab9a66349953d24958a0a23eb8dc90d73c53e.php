<!-- END CONTAINER -->
        ...
        <script src="<?php echo e(URL::asset('assets/js/components-bootstrap-multiselect.min.js')); ?>" type="text/javascript"></script>
         ...
         <script src="<?php echo e(URL::asset('assets/js/bootstrap-datetimepicker.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(URL::asset('assets/js/bootstrap-datetimepicker.fr.js')); ?>" type="text/javascript"></script>


        <!-- END THEME LAYOUT SCRIPTS -->
      <?php if(isset($js_file)): ?>

        <?php $__currentLoopData = $js_file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $js): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php else: ?>
         ...
         <script src="<?php echo e(URL::asset('assets/js/bootbox.js')); ?>" type="text/javascript"></script>
          ...
          <script src="<?php echo e(URL::asset('assets/js/angular.js')); ?>"></script>
          <script src="<?php echo e(URL::asset('assets/js/app.js?q=fhsadfsd')); ?>"></script>
      <?php endif; ?>
...
<script type="text/javascript">
  $(function(){
    ...
    <?php if(isset($_REQUEST['prize']) && $_REQUEST['prize']==true): ?>
    $('#popMsg2').modal('show'); 
    <?php endif; ?> 
...
// example.php will be used to send the data to the sever database
  ...
  if($('#editable').length){ 
    ...
    $('#editable').Tabledit({
        url: "<?php echo e(url('admin/updatePoint')); ?>",
        editButton: false,
        deleteButton: false,
        hideIdentifier: true,
        columns: {
...
<?php /**PATH /var/www/web/modules/Admin/views/layouts/footer.blade.php ENDPATH**/ ?>