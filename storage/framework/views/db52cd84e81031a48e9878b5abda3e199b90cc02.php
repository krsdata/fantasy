                            ...
                            <div class="portlet light portlet-fit bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="<?php echo e(route('notification')); ?>" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="<?php echo e(route('notification')); ?>">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="contact">
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                             <th>  <?php echo e(++$key); ?> </th>
                                                <td> <?php echo e($result->title); ?> 
                                                    <br>
    <a href="https://api.ninja11.in/api/v2/customMessage?title=<?php echo e(urlencode($result->title)); ?>&message=Get ready with your Squad" class="btn-success" target="_blank">
                                                            Resend
                                                    </a>
                                                </td>
                                                 <td> <?php echo e($result->message); ?> </td>
                                                 <td> <?php echo e($result->message_type); ?> </td>
                                                    <!-- <td>  <a href="<?php echo e(route('notification.show',$result->id)); ?>">
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('notification.edit',$result->id)); ?>">
                                                            <i class="fa fa-edit" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('notification.destroy', $result->id))); ?>
                                    ...
                                    <span>
                                     ...
                                     <div class="center" align="center">  <?php echo $notification->appends(['search' => isset($_GET['search'])?$_GET['search']:''])->render(); ?></div>
                                </div>
                            </div>
...
<?php echo Form::model($notification, ['route' => ['notification.store'],'class'=>'form-horizontal user-form','id'=>'user-form','enctype'=>'multipart/form-data']); ?>
...
<?php /**PATH /var/www/web/modules/Admin/views/notification/home.blade.php ENDPATH**/ ?>