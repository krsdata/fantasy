                            ...
                            <div class="portlet light portlet-fit bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="<?php echo e(route('banner')); ?>" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="<?php echo e(route('banner')); ?>">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                        ...
                                        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <img src="<?php echo e(url::asset('storage/uploads/banner/'.$result->photo)); ?>" width="100px"> </a>  </td>
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('banner.edit',$result->id)); ?>">
                                                            <i class="fa fa-edit" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('banner.destroy', $result->id))); ?>
...
<?php /**PATH /var/www/web/modules/Admin/views/banner/home.blade.php ENDPATH**/ ?>